...
namespace PlotterService_UnitTests.PlotterToolWindowTest
{
    /// <summary>
    ///This is a test class for PlotterToolWindowTest and is intended
    ///to contain all PlotterToolWindowTest Unit Tests
    ///</summary>
    [TestClass()]
    public class PlotterToolWindowTest
    {
        ...
        public void MyToolWindowConstructorTest()
        {
            ...
            PlotterToolWindow target = new PlotterToolWindow();
